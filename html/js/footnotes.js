...
$(document).ready(function () {
  ...
  var Footnotes = {
    ...
    setup: function () {
      ...
      footnotelinks.unbind('focusout', Footnotes.footnoteout);
      ...
      footnotelinks.bind('focusout', Footnotes.footnoteout);
    },
    footnoteclick: function () {
      ...
      // To be able to fire focusout event when clicked outside:
      div.attr('tabindex', '0'); 

      div.bind('click', Footnotes.divclick);
      div.bind('focusout', Footnotes.footnoteout);
